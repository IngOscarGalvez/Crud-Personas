                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <b-button v-b-modal.modal @click="modal(1,'Reunion','')" size="sm" variant="primary">
                                <i class="fas fa-plus"></i> Crear Reunion
                            </b-button>
                        ...
                        <div class="card-body">
                            <v-client-table :columns="columns" :data="array" :options="options" >
                                ...
                                <div slot="options" slot-scope="props">
                                    <router-link :to="{name:'reunion-asistencia',params:{id:props.row.id}}">
                                        <b-button size="sm" variant="info"><i class="fas fa-plus" ></i></b-button>
                                    </router-link>

                                    <b-button v-b-modal.modal @click="modal(2,'Reunion',props.row)"                                              
    ...
    export default {
        ...
        methods : {
            ...
            eliminar(row){
                ...
                let me=this;
                this.$bvModal.msgBoxConfirm('Deseas Eliminar la Reunion?')
                    .then(value => {
                        if(value){
                            axios.delete('/Reunion/'+row,{
                                'id':row,
                                '_token':this.csrfToken
                            })
                                .then(function (response) {
            ...
            modal(caso,modelo,data=[]){
                switch (caso) {
                    case 1:
                        this.modal_text='Crear Reunion';
                        this.tipo=1;
                        this.nombre='';

                        break;
                    case 2:
                        this.modal_text='Editar Reunion';
