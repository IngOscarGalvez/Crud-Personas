                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <b-button v-b-modal.modal @click="modal(1,'Dependencia','')" size="sm" variant="primary">
                        ...
                        <div class="card-body">
                            <v-client-table :columns="columns" :data="array" :options="options" >
                                ...
                                <div slot="options" slot-scope="props">
                                    <b-button v-b-modal.modal @click="modal(2,'Dependencia',props.row)"
                                              v-b-tooltip.hover.topright="'Editar Dependencia'"
                                              size="sm" variant="warning" >
                                        <i class="fas fa-pen"></i>
                                    </b-button>

                                    <b-button @click="eliminar(props.row.id)"
                                              v-b-tooltip.hover.topright="'Eliminar'"
                                              size="sm" variant="danger" >
                                        <i class="fas fa-trash"></i>
                                    </b-button>

                                    <b-button @click="estado(props.row.id)"
                                              v-b-tooltip.hover.topright="'Estado'"
        ...
        methods : {
            ...
            enviar(){
                ...
                switch (this.tipo) {
                    ...
                    case 2:
                        axios.put('/dependencias/'+this.id,{
                            'nombre':this.nombre,
                            '_token':this.csrfToken
                        })
                            .then(function (response) {
            ...
            estado(id){
                let me=this;
                axios.post('/dependencias/estado',{
                    'id':id,
                    '_token':this.csrfToken
                })
                    .then(function (response) {
