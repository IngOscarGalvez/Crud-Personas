    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Vehiculo</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <b-button v-b-modal.modal @click="modal(1,'Vehiculo','')" size="sm" variant="primary">
                                <i class="fas fa-plus"></i> Crear Vehiculo
                            </b-button>
                        ...
                        <div class="card-body">
                            <v-client-table :columns="columns" :data="array" :options="options" >
                                ...
                                <div slot="options" slot-scope="props">
                                    <b-button v-b-modal.modal @click="modal(2,'Vehiculo',props.row)"                                              
    ...
    export default {
        ...
        methods : {
            ...
            modal(caso,modelo,data=[]){
                switch (caso) {
                    case 1:
                        this.modal_text='Crear Vehiculo';
                        this.tipo=1;
                        this.nombre='';

                        break;
                    case 2:
                        this.modal_text='Editar Vehiculo';
