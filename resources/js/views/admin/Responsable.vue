    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Responsable</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <b-button v-b-modal.modal @click="modal(1,'Responsable','')" size="sm" variant="primary">
                        ...
                        <div class="card-body">
                            <v-client-table :columns="columns" :data="array" :options="options" >
                                ...
                                <div slot="options" slot-scope="props">
                                    <b-button v-b-modal.modal @click="modal(2,'Responsable',props.row)"
    ...
    export default {
        ...
        methods : {
            ...
            modal(caso,modelo,data=[]){
                switch (caso) {
                    case 1:
                        this.modal_text='Crear Responsable';
                        this.tipo=1;
                        this.nombre='';

                        break;
                    case 2:
                        this.modal_text='Editar Responsable';
