            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1 class="m-0 text-dark">Crear Persona</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="nombre_apellido" v-model="form.nombre_apellido" >
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="cedula">Cedula</label>
                                                        <input type="number" class="form-control" id="cedula" v-model="form.cedula" >
                                                    </div>
                                                    <div class="form-group col-md-6">
        ...
        methods : {
            ...
            guardar(){
                axios.post('/persona',{
                    ...
                    .then(function (response) {
                        // handle success
                        Swal.fire('Hecho!','Se Creo la Persona','success')
                    })
                    .catch(error => {
                        if (error.response.status === 403) {
                            // El servidor respondió con un error 403
                            console.log(error.response.data.message); // Muestra el mensaje de error del servidor
