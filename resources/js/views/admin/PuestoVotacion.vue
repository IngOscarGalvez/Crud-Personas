    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Puesto Votacion</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/">Principal</a></li>
                            <li class="breadcrumb-item active">Puesto Votacion</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <b-button v-b-modal.modal @click="modal(1,'Puesto Votacion','')" size="sm" variant="primary">
                                <i class="fas fa-plus"></i> Crear Puesto Votacion
                            </b-button>
                        ...
                        <div class="card-body">
                            <v-client-table :columns="columns" :data="array" :options="options" >
                                ...
                                <div slot="options" slot-scope="props">
                                    <b-button v-b-modal.modal @click="modal(2,'Puesto Votacion',props.row)"
        ...
        methods : {
            ...
            enviar(){
                ...
                switch (this.tipo) {
                    ...
                    case 2:
                        axios.put('/puestoVotacion/'+this.id,{
                            'nombre':this.nombre,
                            '_token':this.csrfToken
                        })
                            .then(function (response) {
            ...
            eliminar(row){
                ...
                this.$bvModal.msgBoxConfirm('Deseas Eliminar la Dependencia?')
                    .then(value => {
                        if(value){
                            axios.delete('/puestoVotacion/'+row,{
                                'id':row,
                                '_token':this.csrfToken
                            })
                                .then(function (response) {
            ...
            modal(caso,modelo,data=[]){
                switch (caso) {
                    case 1:
                        this.modal_text='Crear Puesto Votacion';
                        this.tipo=1;
                        this.nombre='';

                        break;
                    case 2:
                        this.modal_text='Editar Puesto Votacion';
            ...
            estado(id){
                let me=this;
                axios.post('/puestoVotacion/estado',{
                    'id':id,
                    '_token':this.csrfToken
                })
                    .then(function (response) {
