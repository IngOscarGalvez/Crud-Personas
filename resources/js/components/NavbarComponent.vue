<template>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <div>
            <b-button v-b-toggle.sidebar-right><i class="far fa-user"></i> Account</b-button>
            <b-sidebar id="sidebar-right" title="Account" right shadow>
                ...
                <div class="px-3 py-2">
                    ...
                    <button class="btn btn-outline-primary btn-block" v-b-modal.modalAcount><span class="fas fa-cogs"></span> Profile</button>
                ...
                <div class="px-3 py-2">
                    ...
                    <form id="logout-form" action="/logout" method="POST">
                        ...
                        <button type="submit" class="btn btn-outline-danger btn-block"><span class="fas fa-sign-out-alt"></span> Logout</button>
                    </form>
                </div>
            </b-sidebar>
        </div>
